---
slug: "meta-ray-ban-privacy-light"
title: "Meta's Ray-Ban privacy light isn't about protecting the person being filmed"
description: "The LED that's supposed to warn people they're being filmed only stops recording if it's covered before anything starts. Every real incident happened after."
...
whoBenefits: >-
  The wearer gets a feature that works exactly as advertised: recording that's easy to start and hard for anyone nearby to catch, plus a tamper lock they can point to as proof Meta "did something." Meta gets a product growing 167 percent year over year and a headline-safe answer whenever a reporter asks about consent. The person being filmed gets none of that. They get a light that only ever worked in the one scenario that was never the actual problem.
operatorsRead: >-
  Eleven years shipping consumer product taught me to recognize this pattern on sight: something goes wrong in public, and the team ships a fix that's real, defensible, and aimed at the wrong failure mode. A tamper lock stops someone from disabling the warning light. It does nothing for the far more common case, someone simply starting to record before anyone nearby has a reason to look for a light at all. That isn't incompetence. It's what happens when the fix has to ship fast enough to answer a news cycle, while the redesign that actually changes when and how recording starts would take a lot longer and cost a lot more.
verdict: "skip"
verdictNote: >-
